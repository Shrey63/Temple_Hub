...
<center><div class="jumbotron" id="j1">
    <h1 class="h"> Kedarnath Temple</h1>
    </div>
    </center>
            ...
            <div class="carousel-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12 testimonials_grid">
                            <div class="testi-text text-center">
                                <img src="images/kedarnath/3.jpg" alt="" style="height: 600px; width:1000px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="row">
                        <div class="col-lg-12 testimonials_grid">
                            <div class="testi-text text-center">
                                <img src="images/kedarnath/4.jpg" alt="" style="height: 600px;width:1000px;">                                
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row">
                        <div class="col-lg-12 testimonials_grid">
                            <div class="testi-text text-center">
                                <img src="images/kedarnath/1.jpg" alt="" style="height: 600px;width:1000px;" >
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row">
                        <div class="col-lg-12 testimonials_grid">
                            <div class="testi-text text-center">
                                <img src="images/kedarnath/5.jpg" alt="no img oops " style="height: 600px;width:1000px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="row">
                        <div class="col-lg-12 testimonials_grid">
                            <div class="testi-text text-center">
                                <img src="images/kedarnath/2.jpg" alt="" style="height: 600px; width:1000px;">
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- //testimonials -->
<br><br><br><br>
<center><h4  id="time">Timing :- 4:00 am to 09:00 pm </h4><br></center><br><br>
<center>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="jumbotron" id="j2">
            ...
            The Temple at Kedarnath presents an imposing sight, standing in middle of a wide plateau surrounded by lofty snow covered peaks. The historical name of this region is "Kedar Khand". Kedarnath temple is a part of Char Dhams and Panch Kedar in Uttarakhand and one of the 12 Jyotirlingas of Lord Shiva in India.
...
<br><br><br>
    <iframe width="1200px" height="600px" src="https://www.youtube.com/embed/ANwliN2DYjQ-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
</center>
<br><br><br>
<!-- //breadcrumbs -->
<!-- portfolio -->
                ...
                <div style="border-radius: 10px;" class="img-grid">
                    <div class="port-desc text-center">
                        ...
                        font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;margin-bottom: 0px;margin-top: 0px;" class="main-title-w3pvt text-center">
                         <a href="http://www.kedarriverretreat.com/" target="_blank"><span style="color:red;margin-left: 0px;margin-top: 0px;font-size: 30px;" class="fa fa-map-marker p-sm-4 p-2"></span></a>KEDAR RIVER</h6>
                        <img src="images/kedarnath/s1.jpg" style="height:40px ;width: 150px;align-content:left;"/>
                    </div>
                    <div class="gallery-grid1">
                       
                            <img src="images/kedarnath/h1.jpg" style="height:190px;" alt=" " class="img-fluid" />
                    </div>
                </div>
            </li>
            <li class="col-lg-4  col-md-6">
                <div style="border-radius: 10px;" class="img-grid">
                    <div class="gallery-grid1">
                        ...
                        <img src="images/kedarnath/h2.jfif" style="width:300px; height:200px;" alt=" " class="img-fluid" />
                    ...
                    <div class="port-desc text-center">
                        ...
                        <h6 style="font-size:x-large;color:midnightblue;font-weight: bolder;font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;margin-bottom: 0px;" class="main-title-w3pvt text-center">
                            <a href="https://shivalikvalleyresorts.com/" target="_blank"><span style="color:red;margin-left: 0px;margin-top: 0px;font-size: 30px;" class="fa fa-map-marker p-sm-4 p-2"></span></a>SHIVALIK VALLEY</h6>
                        <img src="images/kedarnath/s2.jpg" style="height:40px ;width: 160px;align-content:left;">
            ...
            <li class="col-lg-4  col-md-6 my-lg-0 my-md-4 mx-auto">
                <div style="border-radius: 10px;" class="img-grid">
                    <div class="port-desc text-center">
                        <span class="line-wthree"></span>
                        <h6 style="font-size:x-large;color:midnightblue;font-weight:bolder;font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;margin-bottom: 0px;" class="main-title-w3pvt text-center">
                            <a href="https://therajpalace.in/" target="_blank"><span style="color:red;margin-left: 0px;margin-top: 0px;font-size: 30px;" class="fa fa-map-marker p-sm-4 p-2"></span></a> RAJ PALACE</h6>                        
                        
                        <img src="images/kedarnath/s3.jpg" style="height:40px ;width: 150px;align-content:left;">
                    </div>
                    <div class="gallery-grid1">
                        
                         <img src="images/kedarnath/h3.jpg" alt=" " class="img-fluid" /></a>
                    ...
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="#exampleModal2" data-toggle="modal" aria-pressed="false" data-target="#exampleModal2"
                                role="button">
                                <img class="card-img-bottom" src="images/kedarnath/p1.jfif" alt="Card image cap" height="200px">
                                <span class="post-icon bg-theme1" id="blog1">Sonprayag </span>
                        ...
                        <div class="card-body" id="blog2">
                            ...
                            <p > 'Prayag' means confluence and Sonprayag lies at the confluence of two holy rivers Basuki and Mandakini.</p>
                            <button type="button" class="btn blog-btn wthree-bnr-btn mt-3 w3_pvt-link-bnr" data-toggle="modal"
                                ...
                                <a href="https://www.euttaranchal.com/tourism/sonprayag.php" target="_blank">Read more</a>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mt-sm-0 mt-5">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="#exampleModal2" data-toggle="modal" aria-pressed="false" data-target="#exampleModal2"
                                role="button">
                                <img class="card-img-bottom" src="images/kedarnath/p2.jfif" alt="Card image cap" height="200px">
                                <span class="post-icon bg-theme1"id="blog1">Vasuki Tal Lake</span>
                        ...
                        <div class="card-body" id="blog2">
                            ...
                            <p > One can spot Brahma Kamal & other Himalayan flowers blooming around the placid lake, making the aura divine. </p>
                            <button type="button" class="btn blog-btn wthree-bnr-btn mt-3 w3_pvt-link-bnr" data-toggle="modal"
                                aria-pressed="false" data-target="#exampleModal2">
                                <a href="https://www.euttaranchal.com/tourism/vasuki-tal.php" target="_blank">Read more</a>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header p-0  position-relative">
                            <a href="#exampleModal4" data-toggle="modal" aria-pressed="false" data-target="#exampleModal4"
                                role="button">
                                <img class="card-img-bottom" src="images/kedarnath/p3.jfif" alt="Card image cap" height="200px">
                                <span class="post-icon bg-theme1"id="blog1">Shankaracharya Samadhi</span>
                            </a>
                        </div>
                        <div class="card-body" id="blog2">
                            <h5 class="blog-title card-title font-weight-bold">
                            ...
                            <p >He was a philosopher & theologian who is credited with unifying & established the main currents of thought in Hinduism.</p>
                            <button type="button" class="btn blog-btn wthree-bnr-btn mt-3 w3_pvt-link-bnr" data-toggle="modal"
                                aria-pressed="false" data-target="#exampleModal4">
                                <a href="https://www.euttaranchal.com/tourism/shankaracharya-samadhi.php" target="_blank">Read more</a>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mt-sm-0 mt-5">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="#exampleModal2" data-toggle="modal" aria-pressed="false" data-target="#exampleModal2"
                                role="button">
                                <img class="card-img-bottom" src="images/kedarnath/p4.jfif" alt="Card image cap" height="200px">
                                <span class="post-icon bg-theme1"id="blog1">Bhairav Temple</span>
                        ...
                        <div class="card-body" id="blog2">
                            ...
                            <p >The temple is dedicated to Bhairav – the fierce manifestation of Lord Shiva associated with destruction & devastation. </p>
                            <button type="button" class="btn blog-btn wthree-bnr-btn mt-3 w3_pvt-link-bnr" data-toggle="modal"
                                aria-pressed="false" data-target="#exampleModal2">
                               <a href="https://www.euttaranchal.com/tourism/bhairav-temple.php" target="_blank"> Read more</a>
                            </button>
                        </div>
                    </div>
                </div>
